...
--                                     Ada_Lib.Help.Modifier);
   ...
   begin
      return Log_Here (Unit_Test_Options /= Null,
         Debug or Trace_Pre_Post_Conditions, "unit test options not set");
   ...
   begin
      ...
      when Ada_Lib.Options.Program =>
         ...
         Ada_Lib.Help.Add_Option ('s', "suite to test", "select test suite to run.",
            Component);
         Ada_Lib.Help.Add_Option ('A', "suites", "enable default disabled suites.",
      ...
      when Ada_Lib.Options.Traces =>
         ...
         Put_Line ("      " & Trace_Prefix & "a              AUnit.Ada_Lib.Debug");
