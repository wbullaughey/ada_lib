...
package Smart_Heap_Pointer		is new Ada_Lib.Smart_Pointer.Pointer (
	Base_Type	=> Smart_Heap_Object.Object_Type,
	Base_Access	=> Smart_Heap_Object.Object_Class_Access);
