...
package Smart_Heap_Object is

	type Object_Type			is new Ada_Lib.Smart_Pointer.Contents_type with private;

	subtype Object_Class		is Object_Type'class;

	type Object_Class_Access	is access all Object_Class;

	function Create (
		Value					: in	 Integer
	) return Object_Class_Access;
