...
package Ada_Lib.Test_States is
   ...
   subtype Window_Type           is Standard.GNOGA.Gui.Window.Window_Type;
   subtype Window_Class_Access   is Standard.GNOGA.Gui.Window.Pointer_To_Window_Class;
   type Window_Constant_Class_Access
                                 is access constant Window_Type'class;
   type Window_Connection_Class_Access
                     is access all Standard.GNOGA.Types.Connection_Data_Type'class;
