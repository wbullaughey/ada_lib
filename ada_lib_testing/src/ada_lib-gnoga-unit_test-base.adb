...
-- Test_Completed                : Boolean := False;
   ...
   begin
      ...
      Ada_Lib.GNOGA.Base.Message_Loop_Signal.Completed;
   end Button_On_Exit;
...
----------------------------------------------------------------------------
   ...
   begin
      Log_In (Debug or Trace_Set_Up,
         "initialize gnoga " & Test.Initialize_GNOGA'img);
--    Test_Completed := False;
      Ada_Lib.GNOGA.Set_Connection_Data (new Connection_Type);
   ...
   begin
      ...
      Ada_Lib.GNOGA.Base.Initialize_GNOGA (Handler,
