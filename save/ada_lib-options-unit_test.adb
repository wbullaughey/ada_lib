...
--          Options.Mode = Ada_Lib.Options.Unit_Test.Run_Tests) then
...
--       Program_Options_Type (Options).Initialize, Debug or Trace_Options);
-- end Initialize;
...
--    case Mode is
--
--       when Ada_Lib.Options.Unit_Test.Driver_Suites =>
--          Put_Line ("suite: " & Suite & " routine: " & Routine);
--
--       when Ada_Lib.Options.Unit_Test.List_Suites =>
--          Put_Line (Suite & " " & Routine);
--
--       when Ada_Lib.Options.Unit_Test.Print_Suites =>
--          Put_Line ("      " & Routine);
--
--       when Ada_Lib.Options.Unit_Test.Run_Tests =>
--          null;
--
--    end case;
--    Log_Out (Debug);
...
--
--       when Ada_Lib.Options.Unit_Test.Driver_Suites |
--            Ada_Lib.Options.Unit_Test.List_Suites |
--            Ada_Lib.Options.Unit_Test.Run_Tests =>
--          null;
--
--       when Ada_Lib.Options.Unit_Test.Print_Suites =>
--          if First then
