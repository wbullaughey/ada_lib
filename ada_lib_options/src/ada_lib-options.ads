...
package Ada_Lib.Options is
   ...
   type SubRoot_option_Type           is (Plain, Modified);
   ...
   Unmodified                    : constant Character :=
     ...
     type Root_Option_Type          is abstract tagged record
        Kind                        : Option_Kind_Type := Nil_Option;
        Modifier                    : Character := Unmodified;
        Option                      : Character;
     end record;

     type Root_Option_Class_Access  is access all Root_Option_Type'class;

   type Root_Options_Type           is array (Positive range <>) of
                                       Root_Option_Class_Access;
   type Root_Options_Access         is access Root_Options_Type;

--   function Create_Option (
--      Option                     : in     Character;
--      Modifier                   : in     Character;
--      From                       : in     String := Here
--   ) return Root_Option_Type is abstract;
...
--   type Options_Type             is array (Positive range <>) of Root_Option_Type;
...
--
     type Command_Line_Iterator_Interface
        ...
        function Get_Option (
           Iterator          : in   Command_Line_Iterator_Interface
        ) return Root_Option_Type'class is abstract;
...
-- Null_Option                   : constant Root_Option_Type := Root_Option_Type'(
--                                  Kind     => Nil_Option,
--                                  Modifier => Unmodified,
--                                  Option   => No_Option);
